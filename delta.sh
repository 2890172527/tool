Magiskboot=tool/sh/bin1/magiskboot
BOOTIMAGE="$1"
...
$Magiskboot compress=xz tool/sh/bin1/magisk32 magisk32.xz
 
$Magiskboot compress=xz tool/sh/bin1/magisk64 magisk64.xz


$Magiskboot cpio ramdisk.cpio \
"add 0750 $INIT tool/sh/bin1/magiskinit" \
...
#################
echo "合成 boot 镜像"
$Magiskboot repack "$BOOTIMAGE"  >/dev/null 2>&1 || echo "无法合成boot镜像"
